...
import (
	...
	fheosconf "github.com/fhenixprotocol/fheos/conf"
...
type ConfConfig struct {
	...
	Fhenix         fheosarb.FhenixConfig `koanf:"fhenix"`
	Fheos          fheosconf.FheosConfig `koanf:"fheos"`
}
...
func ConfConfigAddOptions(prefix string, f *flag.FlagSet) {
	...
	fheosarb.FhenixConfigAddOptions(prefix+".fhenix", f)
	fheosconf.FheosConfigAddOptions(prefix+".fheos", f)
}
...
var ConfConfigDefault = ConfConfig{
	...
	String:         "",
	ReloadInterval: 0,
	Fhenix:         fheosarb.ConfigDefault,
	Fheos:          fheosconf.ConfigDefault,
}
