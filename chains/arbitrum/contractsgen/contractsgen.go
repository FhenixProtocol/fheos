...
// Random is a free data retrieval call binding the contract method 0xecfa5d94.
//
// Solidity: function random(uint8 utype, int32 securityZone) pure returns(bytes)
func (_FheOps *FheOpsCaller) Random(opts *bind.CallOpts, utype uint8, securityZone int32) ([]byte, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "random", utype, securityZone)
...
//
// Solidity: function random(uint8 utype, int32 securityZone) pure returns(bytes)
func (_FheOps *FheOpsSession) Random(utype uint8, securityZone int32) ([]byte, error) {
	return _FheOps.Contract.Random(&_FheOps.CallOpts, utype, securityZone)
}

// Random is a free data retrieval call binding the contract method 0xecfa5d94.
//
// Solidity: function random(uint8 utype, int32 securityZone) pure returns(bytes)
func (_FheOps *FheOpsCallerSession) Random(utype uint8, securityZone int32) ([]byte, error) {
	return _FheOps.Contract.Random(&_FheOps.CallOpts, utype, securityZone)
}
...
var PrecompilesMetaData = &bind.MetaData{
	...
	Bin: "",
}
