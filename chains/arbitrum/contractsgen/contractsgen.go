...
//
// Solidity: function decrypt(uint8 utype, bytes inputBz, uint256 defaultValue) pure returns(uint256)
func (_FheOps *FheOpsCaller) Decrypt(opts *bind.CallOpts, utype uint8, inputBz []byte, defaultValue *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "decrypt", utype, inputBz, defaultValue)
...
//
// Solidity: function decrypt(uint8 utype, bytes inputBz, uint256 defaultValue) pure returns(uint256)
func (_FheOps *FheOpsSession) Decrypt(utype uint8, inputBz []byte, defaultValue *big.Int) (*big.Int, error) {
	return _FheOps.Contract.Decrypt(&_FheOps.CallOpts, utype, inputBz, defaultValue)
}

// Decrypt is a free data retrieval call binding the contract method 0x7c4697ab.
//
// Solidity: function decrypt(uint8 utype, bytes inputBz, uint256 defaultValue) pure returns(uint256)
func (_FheOps *FheOpsCallerSession) Decrypt(utype uint8, inputBz []byte, defaultValue *big.Int) (*big.Int, error) {
	return _FheOps.Contract.Decrypt(&_FheOps.CallOpts, utype, inputBz, defaultValue)
}
...
// Rol is a free data retrieval call binding the contract method 0xd89b314e.
//
// Solidity: function rol(uint8 utype, bytes lhsHash, bytes rhsHash) pure returns(bytes)
func (_FheOps *FheOpsCaller) Rol(opts *bind.CallOpts, utype uint8, lhsHash []byte, rhsHash []byte) ([]byte, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "rol", utype, lhsHash, rhsHash)
...
//
// Solidity: function rol(uint8 utype, bytes lhsHash, bytes rhsHash) pure returns(bytes)
func (_FheOps *FheOpsSession) Rol(utype uint8, lhsHash []byte, rhsHash []byte) ([]byte, error) {
	return _FheOps.Contract.Rol(&_FheOps.CallOpts, utype, lhsHash, rhsHash)
}

// Rol is a free data retrieval call binding the contract method 0xd89b314e.
//
// Solidity: function rol(uint8 utype, bytes lhsHash, bytes rhsHash) pure returns(bytes)
func (_FheOps *FheOpsCallerSession) Rol(utype uint8, lhsHash []byte, rhsHash []byte) ([]byte, error) {
	return _FheOps.Contract.Rol(&_FheOps.CallOpts, utype, lhsHash, rhsHash)
}

// Ror is a free data retrieval call binding the contract method 0x2456e7f2.
//
// Solidity: function ror(uint8 utype, bytes lhsHash, bytes rhsHash) pure returns(bytes)
func (_FheOps *FheOpsCaller) Ror(opts *bind.CallOpts, utype uint8, lhsHash []byte, rhsHash []byte) ([]byte, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "ror", utype, lhsHash, rhsHash)
...
//
// Solidity: function ror(uint8 utype, bytes lhsHash, bytes rhsHash) pure returns(bytes)
func (_FheOps *FheOpsSession) Ror(utype uint8, lhsHash []byte, rhsHash []byte) ([]byte, error) {
	return _FheOps.Contract.Ror(&_FheOps.CallOpts, utype, lhsHash, rhsHash)
}

// Ror is a free data retrieval call binding the contract method 0x2456e7f2.
//
// Solidity: function ror(uint8 utype, bytes lhsHash, bytes rhsHash) pure returns(bytes)
func (_FheOps *FheOpsCallerSession) Ror(utype uint8, lhsHash []byte, rhsHash []byte) ([]byte, error) {
	return _FheOps.Contract.Ror(&_FheOps.CallOpts, utype, lhsHash, rhsHash)
}

// SealOutput is a free data retrieval call binding the contract method 0xa1848ff3.
//
// Solidity: function sealOutput(uint8 utype, bytes inputBz, bytes pk) pure returns(string)
func (_FheOps *FheOpsCaller) SealOutput(opts *bind.CallOpts, utype uint8, inputBz []byte, pk []byte) (string, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "sealOutput", utype, inputBz, pk)
...
//
// Solidity: function sealOutput(uint8 utype, bytes inputBz, bytes pk) pure returns(string)
func (_FheOps *FheOpsSession) SealOutput(utype uint8, inputBz []byte, pk []byte) (string, error) {
	return _FheOps.Contract.SealOutput(&_FheOps.CallOpts, utype, inputBz, pk)
}

// SealOutput is a free data retrieval call binding the contract method 0xa1848ff3.
//
// Solidity: function sealOutput(uint8 utype, bytes inputBz, bytes pk) pure returns(string)
func (_FheOps *FheOpsCallerSession) SealOutput(utype uint8, inputBz []byte, pk []byte) (string, error) {
	return _FheOps.Contract.SealOutput(&_FheOps.CallOpts, utype, inputBz, pk)
}

// Select is a free data retrieval call binding the contract method 0xc2d96952.
//
// Solidity: function select(uint8 utype, bytes controlKey, bytes ifTrueKey, bytes ifFalseKey) pure returns(bytes)
func (_FheOps *FheOpsCaller) Select(opts *bind.CallOpts, utype uint8, controlKey []byte, ifTrueKey []byte, ifFalseKey []byte) ([]byte, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "select", utype, controlKey, ifTrueKey, ifFalseKey)
...
//
// Solidity: function select(uint8 utype, bytes controlKey, bytes ifTrueKey, bytes ifFalseKey) pure returns(bytes)
func (_FheOps *FheOpsSession) Select(utype uint8, controlKey []byte, ifTrueKey []byte, ifFalseKey []byte) ([]byte, error) {
	return _FheOps.Contract.Select(&_FheOps.CallOpts, utype, controlKey, ifTrueKey, ifFalseKey)
}

// Select is a free data retrieval call binding the contract method 0xc2d96952.
//
// Solidity: function select(uint8 utype, bytes controlKey, bytes ifTrueKey, bytes ifFalseKey) pure returns(bytes)
func (_FheOps *FheOpsCallerSession) Select(utype uint8, controlKey []byte, ifTrueKey []byte, ifFalseKey []byte) ([]byte, error) {
	return _FheOps.Contract.Select(&_FheOps.CallOpts, utype, controlKey, ifTrueKey, ifFalseKey)
}
...
var PrecompilesMetaData = &bind.MetaData{
	...
	Bin: "",
}
