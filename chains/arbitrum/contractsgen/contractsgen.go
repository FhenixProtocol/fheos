...
// GetCiphertextData is a free data retrieval call binding the contract method 0x873731af.
//
// Solidity: function getCiphertextData(bytes value) pure returns(bytes)
func (_FheOps *FheOpsCaller) GetCiphertextData(opts *bind.CallOpts, value []byte) ([]byte, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "getCiphertextData", value)
...
//
// Solidity: function getCiphertextData(bytes value) pure returns(bytes)
func (_FheOps *FheOpsSession) GetCiphertextData(value []byte) ([]byte, error) {
	return _FheOps.Contract.GetCiphertextData(&_FheOps.CallOpts, value)
}

// GetCiphertextData is a free data retrieval call binding the contract method 0x873731af.
//
// Solidity: function getCiphertextData(bytes value) pure returns(bytes)
func (_FheOps *FheOpsCallerSession) GetCiphertextData(value []byte) ([]byte, error) {
	return _FheOps.Contract.GetCiphertextData(&_FheOps.CallOpts, value)
}
...
var PrecompilesMetaData = &bind.MetaData{
	...
	Bin: "",
}
