...
// Random is a free data retrieval call binding the contract method 0x8b7854da.
//
// Solidity: function random(uint8 utype, uint64 seed) pure returns(bytes)
func (_FheOps *FheOpsCaller) Random(opts *bind.CallOpts, utype uint8, seed uint64) ([]byte, error) {
	var out []interface{}
	err := _FheOps.contract.Call(opts, &out, "random", utype, seed)
...
//
// Solidity: function random(uint8 utype, uint64 seed) pure returns(bytes)
func (_FheOps *FheOpsSession) Random(utype uint8, seed uint64) ([]byte, error) {
	return _FheOps.Contract.Random(&_FheOps.CallOpts, utype, seed)
}

// Random is a free data retrieval call binding the contract method 0x8b7854da.
//
// Solidity: function random(uint8 utype, uint64 seed) pure returns(bytes)
func (_FheOps *FheOpsCallerSession) Random(utype uint8, seed uint64) ([]byte, error) {
	return _FheOps.Contract.Random(&_FheOps.CallOpts, utype, seed)
}
...
var PrecompilesMetaData = &bind.MetaData{
	...
	Bin: "",
}
