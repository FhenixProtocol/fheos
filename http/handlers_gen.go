...
func ReqHandler(w http.ResponseWriter, r *http.Request) {
	handleRequest(w, r, precompiles.Req)
}
...
func getHandlers() []HandlerDef {
	return []HandlerDef{
		{"/Add", AddHandler}, {"/And", AndHandler}, {"/Div", DivHandler}, {"/Eq", EqHandler}, {"/Gt", GtHandler}, {"/Gte", GteHandler}, {"/Lt", LtHandler}, {"/Lte", LteHandler}, {"/Max", MaxHandler}, {"/Min", MinHandler}, {"/Mul", MulHandler}, {"/Ne", NeHandler}, {"/Not", NotHandler}, {"/Or", OrHandler}, {"/Rem", RemHandler}, {"/Req", ReqHandler}, {"/Rol", RolHandler}, {"/Ror", RorHandler}, {"/Select", SelectHandler}, {"/Shl", ShlHandler}, {"/Shr", ShrHandler}, {"/Square", SquareHandler}, {"/Sub", SubHandler}, {"/Xor", XorHandler}}
}
