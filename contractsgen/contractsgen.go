...
//
// Solidity: function cmux(bytes input) pure returns(bytes)
...
//
// Solidity: function getNetworkPublicKey() pure returns(string)
func (_FheOps *FheOpsCaller) GetNetworkPublicKey(opts *bind.CallOpts) (string, error) {
	var out []interface{}
...
//
// Solidity: function getNetworkPublicKey() pure returns(string)
func (_FheOps *FheOpsSession) GetNetworkPublicKey() (string, error) {
...
//
// Solidity: function getNetworkPublicKey() pure returns(string)
func (_FheOps *FheOpsCallerSession) GetNetworkPublicKey() (string, error) {
	return _FheOps.Contract.GetNetworkPublicKey(&_FheOps.CallOpts)
}
