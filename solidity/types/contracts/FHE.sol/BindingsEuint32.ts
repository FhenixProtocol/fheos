...
export interface BindingsEuint32Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "and"
...
export interface BindingsEuint32 extends BaseContract {
  connect(runner?: ContractRunner | null): BindingsEuint32;
  waitForDeployment(): Promise<this>;

  interface: BindingsEuint32Interface;
