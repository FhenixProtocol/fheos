...
export interface BindingsEuint16Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "and"
...
export interface BindingsEuint16 extends BaseContract {
  connect(runner?: ContractRunner | null): BindingsEuint16;
  waitForDeployment(): Promise<this>;

  interface: BindingsEuint16Interface;
