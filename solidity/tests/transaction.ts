import { AddCaller } from "../types/tests/contracts/Counter";
import { createFheInstance, deployContract } from "./utils";

describe("Test Transactions Scenarios", () => {
  let contract: AddCaller;
  let contractAddr: string;

  it("Contract Deployment", async () => {
    contractCallee = (await deployContract("AddCallee")) as AddCaller;
    contractCaller = (await deployContract("AddCaller")) as AddCaller;
