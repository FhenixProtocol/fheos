...
contract AsEuint64Bench {
    ...
    inEuint64 internal aPreEncrypted;
    ...
    function loadPreEncrypted(inEuint64 calldata _a) public {
        aPreEncrypted = _a;
    }
    ...
    function benchCastPreEncryptedToEuint64() public view {
        FHE.asEuint64(aPreEncrypted);
    }
}
