...
contract AsEaddressBench {
    ...
    inEaddress internal aPreEncrypted;
    ...
    function loadPreEncrypted(inEaddress calldata _a) public {
        aPreEncrypted = _a;
    }
    ...
    function benchCastPreEncryptedToEaddress() public view {
        FHE.asEaddress(aPreEncrypted);
    }
}
