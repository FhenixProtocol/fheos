...
contract AsEuint8Bench {
    ...
    inEuint8 internal aPreEncrypted;
    ...
    function loadPreEncrypted(inEuint8 calldata _a) public {
        aPreEncrypted = _a;
    }
    ...
    function benchCastPreEncryptedToEuint8() public view {
        FHE.asEuint8(aPreEncrypted);
    }
}
