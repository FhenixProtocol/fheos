...
contract GteBench {
    ...
    function benchGteBool() public view {
        FHE.gte(aBool, bBool);
    }
    function benchGte8() public view {
        FHE.gte(a8, b8);
    }
    function benchGte16() public view {
        FHE.gte(a16, b16);
    }
    function benchGte32() public view {
        FHE.gte(a32, b32);
    }
    function benchGte64() public view {
        FHE.gte(a64, b64);
    }
    function benchGte128() public view {
        FHE.gte(a128, b128);
    }
}
