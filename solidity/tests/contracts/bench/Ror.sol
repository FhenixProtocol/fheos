...
contract RorBench {
    ...
    function benchRor8() public view {
        FHE.ror(a8, b8);
    }
    function benchRor16() public view {
        FHE.ror(a16, b16);
    }
    function benchRor32() public view {
        FHE.ror(a32, b32);
    }
    function benchRor64() public view {
        FHE.ror(a64, b64);
    }
    function benchRor128() public view {
        FHE.ror(a128, b128);
    }
}
