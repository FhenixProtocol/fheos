...
contract AsEuint16Bench {
    ...
    inEuint16 internal aPreEncrypted;
    ...
    function loadPreEncrypted(inEuint16 calldata _a) public {
        aPreEncrypted = _a;
    }
    ...
    function benchCastPreEncryptedToEuint16() public view {
        FHE.asEuint16(aPreEncrypted);
    }
}
