...
contract RolBench {
    ...
    function benchRol8() public view {
        FHE.rol(a8, b8);
    }
    function benchRol16() public view {
        FHE.rol(a16, b16);
    }
    function benchRol32() public view {
        FHE.rol(a32, b32);
    }
    function benchRol64() public view {
        FHE.rol(a64, b64);
    }
    function benchRol128() public view {
        FHE.rol(a128, b128);
    }
}
