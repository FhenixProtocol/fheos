...
contract AsEuint32Bench {
    ...
    inEuint32 internal aPreEncrypted;
    ...
    function loadPreEncrypted(inEuint32 calldata _a) public {
        aPreEncrypted = _a;
    }
    ...
    function benchCastPreEncryptedToEuint32() public view {
        FHE.asEuint32(aPreEncrypted);
    }
}
