...
contract MinBench {
    ...
    function benchMinBool() public view {
        FHE.min(aBool, bBool);
    }
    function benchMin8() public view {
        FHE.min(a8, b8);
    }
    function benchMin16() public view {
        FHE.min(a16, b16);
    }
    function benchMin32() public view {
        FHE.min(a32, b32);
    }
    function benchMin64() public view {
        FHE.min(a64, b64);
    }
    function benchMin128() public view {
        FHE.min(a128, b128);
    }
}
