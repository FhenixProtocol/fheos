...
func Shl(utype byte, lhsHash []byte, rhsHash []byte, tp *TxParams) ([]byte, uint64, error) {
	// solgen: 2 verified operands
	return genericBinaryOperation(types.Shl, utype, lhsHash, rhsHash, tp, (*fhe.FheEncrypted).Shl)
}

func Shr(utype byte, lhsHash []byte, rhsHash []byte, tp *TxParams) ([]byte, uint64, error) {
	// solgen: 2 verified operands
	return genericBinaryOperation(types.Shr, utype, lhsHash, rhsHash, tp, (*fhe.FheEncrypted).Shr)
}

func Rol(utype byte, lhsHash []byte, rhsHash []byte, tp *TxParams) ([]byte, uint64, error) {
	// solgen: 2 verified operands
	return genericBinaryOperation(types.Rol, utype, lhsHash, rhsHash, tp, (*fhe.FheEncrypted).Rol)
}

func Ror(utype byte, lhsHash []byte, rhsHash []byte, tp *TxParams) ([]byte, uint64, error) {
	// solgen: 2 verified operands
	return genericBinaryOperation(types.Ror, utype, lhsHash, rhsHash, tp, (*fhe.FheEncrypted).Ror)
}
